...
I am currently working as an ***Undergraduate Researcher*** with [Merck](https://www.merck.com/) (through Purdue's Data Mine program), where I am researching and developing pose-estimation models in order to detect the level of PPE compliance in lab settings and provide text-based contextual inference, using video data.
